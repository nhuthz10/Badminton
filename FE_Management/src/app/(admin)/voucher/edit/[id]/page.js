...
function VoucherPost({ params }) {
  ...
  const fetchVoucherDetail = async () => {
    try {
      ...
      let res = await handleGetVoucherDetail(params.id);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="model-add-update">
      <h1 className="model-add-update-header">Sửa voucher</h1>
      ...
      >
        ...
        >
          <Image
            src={imageValue ? imageValue : "/images/ImgNoProduct.png"}
            alt=""
            priority
            height={230}
            width={180}
